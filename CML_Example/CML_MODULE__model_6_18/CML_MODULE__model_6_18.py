def model_6_18():
    ...
    df['Mol_median'] = (df['Mol_median'] - 10.147764) / 16.596738 #standardization
    ...
    #  standardization
    df['MR_3_6'] = (df['MR_3_6'] - 0.333333) / 0.474137
    ...
    for seed in my_seeds:
        ...
        pred.append(clf.predict(df[['Mol_median', 'MR_3_6']].values))
        prob.append(clf.predict_proba(df[['Mol_median', 'MR_3_6']].values)[:,1])
