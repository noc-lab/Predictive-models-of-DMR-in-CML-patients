def model_3_18():
    ...
    variable_dict = {
        ...
        'Mol_3m_IM' : Mol_3m_IM,
        'WHITE_BLOOD_CELL_COUNT_AT_DIAGNOSIS': (WBC_count_at_diagnosis - 119631.358025) / 95581.016130, #standardization
    }
    ...
    df['Mol_median'] = (df['Mol_median'] - 14.960259) / 22.275554 #standardization         
