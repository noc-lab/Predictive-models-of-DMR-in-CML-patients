def model_12_long():
    ...
    variable_dict = {
        ...
        'WHITE_BLOOD_CELL_COUNT_AT_DIAGNOSIS': (WBC_count_at_diagnosis - 115829.052632) / 93768.243877, #standardization
    }
    ...
    df['Mol_median'] = (df['Mol_median'] - 4.473496) / 10.153238 #standardization
